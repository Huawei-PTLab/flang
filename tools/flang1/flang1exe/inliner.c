...
{
  int astNewl, astNewr, astNew, vastSubs[MAXDIMS], astNewu, astNews, astNewc;
  int asd, sptrEntry;
  int nsubs, sub;
  int sptrRet;
  int shd;
...
copy_inargs(int sptrEntry, int astCall, int stdstart, int stdlast)
{
  ...
  int nargs, arg;
  int argtNew;
  int astArg, astCopy, ast, astl, astu, asts, vastSubs[MAXDIMS], astBnd, astAlloc;
  int shd;
  int dtyp;
  int ndims, dim;
  ADSC *adCopy;
...
promote_assumsz_arg(int sptrDummy, int astArg)
{
  int asd;
  int nsubs, sub;
  int astl, astu, vastSubs[MAXDIMS], ast;
  int dtyp;
...
allocate_adjarrs(int stdstart, int stdlast)
{
  int sptr;
  int ndims, dim;
  int vastSubs[MAXDIMS], astArr, ast, astAlloc, astl, astu;
...
{
  int iar;
  int astLop, astNew, astSS, astSub, vastSubs[MAXDIMS], ast1;
