...
static void emit_scatterx_gatherx(int std, int result, int array, int mask,
                                  ...
                                  int comm_type);
static void compute_permute(int lhs, int rhs, int list, int order[]);
static int put_data(int permute[MAXDIMS], int no);
static LOGICAL is_permuted(int array, int per[MAXDIMS], int per1[MAXDIMS], int *nper1);
 ...
 */
static void
permute_axis(int result, int array, int list, int permute[MAXDIMS])
{
...
static int
put_data(int permute[MAXDIMS], int no)
{
  ADSC *ad;
  int dtype;
  int i, j;
 ...
 */
static void
compute_permute(int lhs, int rhs, int list, int order[MAXDIMS])
{
  int asd, ndim;
  int i, j;
  int count, count1;
...
static LOGICAL
is_permuted(int array, int per[MAXDIMS], int per1[MAXDIMS], int *nper1)
{
  int asd;
  int ndim;
  int count;
