...
enum fold_status fold_complex32_pow(float complex *res, const float complex *x, const float complex *y);
enum fold_status fold_complex64_pow(double complex *res, const double complex *x, const double complex *y);
enum fold_status fold_complex128_pow(long double complex *res, const long double complex *x,
